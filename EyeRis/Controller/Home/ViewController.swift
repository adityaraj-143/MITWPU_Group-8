...
class ViewController: UIViewController {
    ...
    private func registerCells() {
        ...
        CollectionView.register(
            ...
            forSupplementaryViewOfKind: "Bold-header-kind",
            withReuseIdentifier: "bold_header_cell"
        )
...
extension ViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        // Bold header
        let boldHeader = collectionView.dequeueReusableSupplementaryView(
            ofKind: kind,
            withReuseIdentifier: "bold_header_cell",
            for: indexPath
        ) as! HeaderView
        
        boldHeader.configure(str: "Summary")
